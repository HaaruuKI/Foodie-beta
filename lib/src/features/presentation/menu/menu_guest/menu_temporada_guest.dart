...
class MenuTemporadaGuest extends StatefulWidget {
  @override
  _MenuTemporadaGuestState createState() => _MenuTemporadaGuestState();
}

class _MenuTemporadaGuestState extends State<MenuTemporadaGuest> {
...
//** NewestItemWidget
  Future<List<Widget>> _getNewetsItems() async {
    ...
    List<Product> products =
        await productService.getProducts(type: 'temporada');
