...
class MenuComidaGuest extends StatefulWidget {
  @override
  _MenuComidaGuestState createState() => _MenuComidaGuestState();
}

class _MenuComidaGuestState extends State<MenuComidaGuest> {
...
//** NewestItemWidget
  Future<List<Widget>> _getNewetsItems() async {
    ...
    List<Product> products = await productService.getProducts(type: 'comida');
